...
public class NovaMessageMovLIO extends BaseMessage {
    ...
    public void constructSendData() {
        if (isPose)
            this.messageStrContent = ("MovLIO(pose={" + x + "," + y + "," + z + "," + rx + "," + ry + "," + rz + "}");
        else
            this.messageStrContent = ("MovLIO(joint={" + j1 + "," + j2 + "," + j3 + "," + j4 + "," + j5 + "," + j6 + "}");
        if (user>0)
