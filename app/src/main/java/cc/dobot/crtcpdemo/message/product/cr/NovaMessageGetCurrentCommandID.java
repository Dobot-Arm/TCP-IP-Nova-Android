...
public class NovaMessageGetCurrentCommandID extends BaseMessage {
    private static final String MESSAGE_CONTENT="GetCurrentCommandID()";
    ...
    public void constructSendData() {
        ...
        this.REPLY_SIZE=messageContent.length+9;
    }
