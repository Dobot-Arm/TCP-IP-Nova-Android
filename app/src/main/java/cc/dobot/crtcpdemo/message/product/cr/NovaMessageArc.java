...
public class NovaMessageArc extends BaseMessage {
    ...
    public void constructSendData() {
        if (isPose)
            this.messageStrContent = ("Arc(pose={" + x1 + "," + y1 + "," + z1 + "," + rx1 + "," + ry1 + "," + rz1 + "},"+"pose={" + x2 + "," + y2 + "," + z2 + "," + rx2 + "," + ry2 + "," + rz2 + "}");
        else
            this.messageStrContent = ("Arc(joint={" + j1_1 + "," + j2_1 + "," + j3_1 + "," + j4_1 + "," + j5_1 + "," + j6_1 + "},"+"joint={" + j1_2 + "," + j2_2 + "," + j3_2 + "," + j4_2 + "," + j5_2 + "," + j6_2  + "}");
        if (user>0)
        ...
        if (ori_mode>=0)
            this.messageStrContent=this.messageStrContent+",ori_mode="+ori_mode;
    ...
    public int getOri_mode() {
        return ori_mode;
    }

    public void setOri_mode(int ori_mode) {
        this.ori_mode = ori_mode;
        constructSendData();
    }
}
