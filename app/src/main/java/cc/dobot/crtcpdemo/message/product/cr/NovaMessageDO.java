...
public class NovaMessageDO extends BaseMessage {
    ...
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("DO("+index+","+status+((time>=25&&time<=60000)?","+time:"")+")").getBytes(StandardCharsets.US_ASCII);
        }else
